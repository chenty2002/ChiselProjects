...
module hotel(clk,rst,start,showering,fair);
    ...
    Buechi Buechi(clk,Aclean,Bproceed,Adirty,fair,scc);

endmodule // hotel

typedef enum {Init,n1,n2,n3,n4,n5,n6,Trap} states;

module Buechi(clock,Aclean,Bproceed,Adirty,fair,scc);
  input clock,Aclean,Bproceed,Adirty;
  output fair,scc;
  states reg state;
  states wire ND_n3_n4_n6;
  states wire ND_n3_n6;
  states wire ND_n4_n5;
  states wire ND_n1_n2_n3;
  states wire ND_n1_n2_n3_n4_n5;
  states wire ND_n4_n6;
  states wire ND_n1_n2;
  states wire ND_n1_n2_n5;
  states wire ND_n1_n4_n5;
  states wire ND_n1_n5;
  assign ND_n3_n4_n6 = $ND(n3,n4,n6);
  assign ND_n3_n6 = $ND(n3,n6);
  assign ND_n4_n5 = $ND(n4,n5);
  assign ND_n1_n2_n3 = $ND(n1,n2,n3);
  assign ND_n1_n2_n3_n4_n5 = $ND(n1,n2,n3,n4,n5);
  assign ND_n4_n6 = $ND(n4,n6);
  assign ND_n1_n2 = $ND(n1,n2);
  assign ND_n1_n2_n5 = $ND(n1,n2,n5);
  assign ND_n1_n4_n5 = $ND(n1,n4,n5);
  assign ND_n1_n5 = $ND(n1,n5);
  assign fair = (state == n4) || (state == n3);

    assign scc =(state==n3) || (state ==n4) || (state ==n6);
  ...
  always @ (posedge clock) begin
	...
	state = Trap;
      n3,n4:
	case ({Aclean,Adirty,Bproceed})
	3'b000: state = ND_n4_n6;
	3'b??1: state = Trap;
	3'b010: state = n6;
	3'b100: state = ND_n3_n4_n6;
	3'b110: state = ND_n3_n6;
	endcase
      n1:
	case ({Aclean,Bproceed})
	2'b0?: state = n1;
	2'b10: state = ND_n1_n2_n3;
	2'b11: state = ND_n1_n2;
	endcase
      n6:
	case ({Aclean,Bproceed})
	2'b00: state = n6;
	2'b?1: state = Trap;
	2'b10: state = ND_n3_n6;
	endcase
      n2,n5:
	case ({Adirty,Bproceed})
	2'b00: state = ND_n4_n5;
	2'b01: state = n5;
	2'b1?: state = Trap;
	endcase
      Init:
	case ({Aclean,Adirty,Bproceed})
	3'b000: state = ND_n1_n4_n5;
	3'b001: state = ND_n1_n5;
	3'b01?: state = n1;
	3'b100: state = ND_n1_n2_n3_n4_n5;
	3'b101: state = ND_n1_n2_n5;
	3'b110: state = ND_n1_n2_n3;
	3'b111: state = ND_n1_n2;
	endcase
    endcase
  end
endmodule
