// Model for the soap mutual exclusion algorithm.
//
...
module guest(clk, reset, start, reqIn, initpred, granted,
	...
	if (reset) begin
	    ...
	    case (condition)
	      ...
	      showering:
		  if (proceed) condition = clean; // nondeterministic duration
	      default:
